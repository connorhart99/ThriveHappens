        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              <p>
                Thrive Happens was founded by Scott Hanley, a native of Belfast. Scott is a remarkable advocate for resilience, mindset, and functional health—an advocacy grounded in a powerful story of personal growth and change. Diagnosed with Parkinson's in 2017, Scott faced debilitating symptoms, including muscle rigidity, tremors and cognitive decline to name just a few. And life was only going to get worse.
              </p>
              
              <p>
                Through intentional mindset and expectation discipline, along with functional fitness and lifestyle choices, he achieved the 'impossible' and reversed his symptoms. Scott is 3+ years symptom free and continues to Thrive.
              </p>
              
              <p>
                Scott's experience as a former British Army officer further strengthens his message of mental toughness and discipline.
              </p>
              
              <p>
                Combining military service and leadership with his Lived Experience and reversal of Parkinsons Disease, he now works with individuals and business leaders to cultivate habits that support both physical and mental performance.
              </p>
              
              <p>
                He now inspires individuals and groups to strive to Thrive.
              </p>
            </div>
          </div>
        </div>
